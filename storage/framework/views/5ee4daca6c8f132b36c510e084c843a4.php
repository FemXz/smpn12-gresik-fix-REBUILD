    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-number"><?php echo e(count($extracurriculars)); ?>+</div>
        ...
        <div id="extracurricular-grid" class="cards-grid">
            <?php $__empty_1 = true; $__currentLoopData = $extracurriculars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card extracurricular-card" 
                     data-category="<?php echo e(strtolower($item->category ?? 'akademik')); ?>" 
                    ...
                    <div class="card-image">
                        ...
                        <?php else: ?>
                            <?php if(strtolower($item->category ?? 'akademik') == 'olahraga'): ?>
                                <i class="fas fa-futbol"></i>
                            <?php elseif(strtolower($item->category ?? 'akademik') == 'seni'): ?>
                        ...
                        <div class="card-badge">
                            <?php echo e(ucfirst($item->category ?? 'Akademik')); ?>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-info">
                            ...
                            <div>
                                ...
                                <div style="color: var(--text-light);"><?php echo e($item->teacher_in_charge ?? 'Akan segera ditentukan'); ?></div>
                            </div>
                        </div>
                        
                        <p class="card-description">
                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($item->description), 120)); ?>

                        </p>
                        
                        <button class="btn-detail detail-btn"
                            data-name="<?php echo e($item->name); ?>"
                            data-category="<?php echo e(ucfirst($item->category ?? 'Akademik')); ?>"
                            data-description="<?php echo e(strip_tags($item->description)); ?>"
                            data-teacher="<?php echo e($item->teacher_in_charge ?? 'Akan segera ditentukan'); ?>"
                            data-phone="<?php echo e($item->teacher_phone ?? ''); ?>"
                            data-schedule="<?php echo e($item->schedule ?? ''); ?>">
                            <i class="fas fa-info-circle"></i>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\laragon\www\smpn12-gresik-website\resources\views/student/extracurricular.blade.php ENDPATH**/ ?>