    ...
    <div class="container-ekskul">
        ...
        <div class="stats-overlay">
            <div class="stat-item">
                ...
                <span class="stat-val"><?php echo e(count($extracurriculars)); ?>+</span>
        ...
        <div class="ekskul-grid" id="ekskulGrid">
            <?php $__empty_1 = true; $__currentLoopData = $extracurriculars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="ekskul-card" 
                     data-cat="<?php echo e(strtolower($item->category ?? 'akademik')); ?>" 
                    ...
                    <div class="card-img-box">
                        ...
                        <?php else: ?>
                            <i class="fas fa-users"></i>
                        <?php endif; ?>
                        <div class="category-tag"><?php echo e($item->category ?? 'Umum'); ?></div>
                    </div>
                    ...
                    <div class="card-body-ekskul">
                        ...
                        <div class="pembina-info">
                            ...
                            <span><?php echo e($item->teacher_in_charge ?? 'Pembina belum ditentukan'); ?></span>
                        </div>
                        
                        <p class="ekskul-desc">
                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($item->description), 100)); ?>

                        </p>
                        
                        <button class="btn-ekskul-detail open-modal"
                            data-name="<?php echo e($item->name); ?>"
                            data-cat="<?php echo e($item->category ?? 'Umum'); ?>"
                            data-desc="<?php echo e(strip_tags($item->description)); ?>"
                            data-teacher="<?php echo e($item->teacher_in_charge ?? '-'); ?>"
                            data-phone="<?php echo e($item->teacher_phone ?? ''); ?>"
                            data-schedule="<?php echo e($item->schedule ?? 'Akan diinfokan'); ?>">
