<?php $__env->startSection("title", $teacher->name . " - Guru & Staff - SMP Negeri 12 Gresik"); ?>
                    ...
                    <div class="teacher-card">
                        <div class="card-header text-center">
                            <?php if($teacher->photo): ?>
                                <img src="<?php echo e(asset('storage/' . $teacher->photo)); ?>" class="teacher-photo" alt="<?php echo e($teacher->name); ?>">
                            <?php else: ?>
                                <div class="photo-placeholder"><i class="fas fa-user-circle"></i></div>
                            <?php endif; ?>
                            <h1 class="teacher-name"><?php echo e($teacher->name); ?></h1>
                            <p class="teacher-position"><?php echo e($teacher->position); ?></p>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="info-grid">
                                ...
                                <div class="contact-section">
                                    ...
                                    <?php if($teacher->email): ?>
                                        <div class="contact-item">
                                            ...
                                            <div><strong>Email:</strong><br><a href="mailto:<?php echo e($teacher->email); ?>"><?php echo e($teacher->email); ?></a></div>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($teacher->phone): ?>
                                        <div class="contact-item">
                                            <div class="contact-icon phone-icon"><i class="fas fa-phone"></i></div>
                                            <div><strong>Telepon:</strong><br><a href="tel:<?php echo e($teacher->phone); ?>"><?php echo e($teacher->phone); ?></a></div>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($teacher->nip): ?>
                                        <div class="contact-item">
                                            <div class="contact-icon nip-icon"><i class="fas fa-id-card"></i></div>
                                            <div><strong>NIP:</strong><br><?php echo e($teacher->nip); ?></div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <?php if($teacher->bio): ?>
                                    <div class="bio-section">
                                        ...
                                        <div class="bio-content"><?php echo nl2br(e($teacher->bio)); ?></div>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="additional-info">
                                ...
                                <div class="info-items">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-item-content"><strong>Pendidikan:</strong><br><span><?php echo e($teacher->education ?? 'Kosong'); ?></span></div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-item-icon experience-icon"><i class="fas fa-calendar-alt"></i></div>
                                        <div class="info-item-content"><strong>Pengalaman:</strong><br><span><?php echo e($teacher->experience ?? 'Kosong'); ?></span></div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-item-icon subject-icon"><i class="fas fa-book"></i></div>
                                        <div class="info-item-content"><strong>Mata Pelajaran:</strong><br><span><?php echo e($teacher->subject ?? $teacher->position); ?></span></div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-item-icon achievement-icon"><i class="fas fa-trophy"></i></div>
                                        <div class="info-item-content"><strong>Status:</strong><br><span><?php echo e(ucfirst($teacher->status ?? 'Aktif')); ?></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="navigation">
                                <a href="<?php echo e(route('teachers')); ?>" class="btn btn-outline-secondary"><i class="fas fa-arrow-left"></i> Kembali ke Daftar Guru</a>
                                <a href="<?php echo e(route('home')); ?>" class="btn btn-primary"><i class="fas fa-home"></i> Beranda</a>
                            </div>
                        </div>
                    </div>

                    <!-- Related Teachers -->
                    <?php if($relatedTeachers->count()): ?>
                        <div class="related-section mt-5">
                            ...
                            <div class="related-grid">
                                <?php $__currentLoopData = $relatedTeachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <!-- Mengganti col-md-4 dengan struktur grid murni CSS -->
                                    <div class="related-card">
                                        <?php if($related->photo): ?>
                                            <img src="<?php echo e(asset('storage/' . $related->photo)); ?>" class="related-photo" alt="<?php echo e($related->name); ?>">
                                        <?php else: ?>
                                        ...
                                        <p class="card-text small text-muted"><?php echo e($related->position); ?></p>
                                        <a href="<?php echo e(route('teachers.show', $related->slug)); ?>" class="btn btn-outline-primary btn-sm">Lihat Profil</a>
                                    </div>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\laragon\www\smpn12-gresik-website\resources\views/teachers/show.blade.php ENDPATH**/ ?>