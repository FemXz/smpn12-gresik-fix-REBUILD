...
<head>
    ...
    <title><?php echo $__env->yieldContent("title", "Admin Dashboard - SMPN 12 Gresik"); ?></title>
...
<div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('admin.stats.edit') ? 'active' : ''); ?>" href="<?php echo e(route('admin.stats.edit')); ?>">
            ...
            <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('admin.welcome.*') ? 'active' : ''); ?>" 
                    href="<?php echo e(route('admin.welcome.index')); ?>">
                        <i class="fas fa-home"></i>
                        <span>Welcome Head</span>
                    </a>
                </li>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('admin.extracurriculars.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.extracurriculars.index')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('admin.teacher-news.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.teacher-news.index')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('admin.ebooks.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.ebooks.index')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('admin.alumni.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.alumni.index')); ?>">
            ...
            <li class="nav-item">
<a class="nav-link <?php echo e(request()->routeIs('admin.ppdb.settings.*') ? 'active' : ''); ?>"
   href="<?php echo e(route('admin.ppdb.settings.edit')); ?>">
  ...
  <div class="container-fluid flex-wrap justify-content-between align-items-center">
    ...
    <div class="navbar-brand mx-auto order-2 text-center d-flex align-items-center gap-2">
      <span class="fw-bold text-primary"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
    </div>
...
<?php /**PATH C:\Users\Lenovo\Documents\laragon\www\smpn12-gresik-website\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>