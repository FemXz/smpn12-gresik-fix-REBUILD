...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SMP Negeri 12 Gresik - Smart School Unggul dalam Prestasi'); ?></title>

    <!-- SEO Meta Tags -->
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'SMP Negeri 12 Gresik adalah Smart School unggulan yang mengutamakan kualitas pendidikan dengan teknologi modern dan tenaga pengajar profesional.'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'SMP Negeri 12 Gresik - Smart School'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('description', 'Smart School dengan pendidikan berkualitas dan teknologi modern di Gresik'); ?>">
    <meta property="og:image" content="<?php echo e(asset('assets/logo-smp.png')); ?>">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:type" content="website">

    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('assets/logo-smp.png')); ?>">
...
<nav class="navbar" id="mainNavbar">
    <div class="container">
        ...
        <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
            <img src="<?php echo e(asset('assets/logo-smp.png')); ?>" alt="Logo SMPN 12 Gresik">
        ...
        <ul class="navbar-nav d-none d-lg-flex">
            <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link <?php echo e(request()->routeIs('about*') ? 'active' : ''); ?>" href="#">
                        Profil <i class="fas fa-chevron-down dropdown-icon"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="<?php echo e(request()->routeIs('about.organization') ? 'active' : ''); ?>" href="<?php echo e(route('about.organization')); ?>">Profil Singkat</a></li>
                        <li><a class="<?php echo e(request()->routeIs('about.history') ? 'active' : ''); ?>" href="<?php echo e(route('about.history')); ?>">Sejarah</a></li>
                        <li><a class="<?php echo e(request()->routeIs('about.vision-mission') ? 'active' : ''); ?>" href="<?php echo e(route('about.vision-mission')); ?>">Visi & Misi</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link <?php echo e(request()->routeIs('programs*') || request()->routeIs('academic*') ? 'active' : ''); ?>" href="#">
                        Akademik <i class="fas fa-chevron-down dropdown-icon"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="<?php echo e(request()->routeIs('programs*') ? 'active' : ''); ?>" href="<?php echo e(route('programs')); ?>">
                                Program Keahlian
                            </a>
                        </li>
                        <li>
                            <a class="<?php echo e(request()->routeIs('academic.extracurricular*') ? 'active' : ''); ?>" href="<?php echo e(route('academic.extracurricular')); ?>">
                                Ekstrakurikuler
                            </a>
                        </li>
                    </ul>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('teachers')); ?>">Guru & Staff</a>
            </li>
           <li class="nav-item dropdown">
  <a class="nav-link <?php echo e(request()->routeIs('information.*') || request()->routeIs('academic*') ? 'active' : ''); ?>" href="#">
    Informasi <i class="fas fa-chevron-down dropdown-icon"></i>
  </a>
  <ul class="dropdown-menu">
    <li>
      <a class="<?php echo e(request()->routeIs('information.news') ? 'active' : ''); ?>" href="<?php echo e(route('information.news')); ?>">
        Berita
      </a>
    </li>
    <li>
      <a class="<?php echo e(request()->routeIs('information.ppdb') ? 'active' : ''); ?>" href="<?php echo e(route('information.ppdb')); ?>">
        Informasi PPDB
      </a>
    </li>
  </ul>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('gallery') ? 'active' : ''); ?>" href="<?php echo e(route('gallery')); ?>">Galeri</a>
            </li>
            <li class="nav-item">
...
<div class="mobile-sidebar" id="mobileSidebar">
    ...
    <div class="sidebar-body">
        ...
        <ul class="sidebar-nav">
            <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('home')); ?>">Beranda</a></li>
            <li class="sidebar-item dropdown">
                <a class="sidebar-link" href="#">Profil <i class="fas fa-plus"></i></a>
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('about')); ?>">Profil Sekolah</a></li>
                    <li><a href="<?php echo e(route('about.history')); ?>">Sejarah</a></li>
                    <li><a href="<?php echo e(route('about.vision-mission')); ?>">Visi & Misi</a></li>
                </ul>
            </li>
            <li class="sidebar-item dropdown">
                <a class="sidebar-link" href="#">Akademik <i class="fas fa-plus"></i></a>
                <ul class="sidebar-submenu">
                    <li><a href="<?php echo e(route('programs')); ?>">Program Keahlian</a></li>
                    <li><a href="<?php echo e(route('academic.extracurricular')); ?>">Ekstrakurikuler</a></li>
                </ul>
            </li>
             <li class="sidebar-item dropdown">
                <a class="sidebar-link" href="#">Informasi <i class="fas fa-plus"></i></a>
                <ul class="sidebar-submenu">
                   <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('information.news')); ?>">Berita</a></li>
                    <li><a href="<?php echo e(route('academic.extracurricular')); ?>">PPDB</a></li>
                </ul>
            </li>
            <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('teachers')); ?>">Guru & Staff</a></li>
            <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('gallery')); ?>">Galeri</a></li>
            <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('contact')); ?>">Kontak</a></li>
        </ul>
    </div>
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <div class="footer-brand">
                        <img src="<?php echo e(asset('assets/logo-smp.png')); ?>" alt="Logo SMP Negeri 12 Gresik">
                        <div>
            ...
            <div class="footer-bottom">
                <p>&copy; <?php echo e(date('Y')); ?> SMP Negeri 12 Gresik. Semua hak dilindungi.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\Users\Lenovo\Documents\laragon\www\smpn12-gresik-website\resources\views/layouts/app.blade.php ENDPATH**/ ?>