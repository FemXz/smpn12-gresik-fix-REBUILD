...
<nav class="navbar" id="mainNavbar">
    ...
    <li>
        <a class="<?php echo e(request()->routeIs('about.organization') ? 'active' : ''); ?>"
           href="<?php echo e(route('about.organization')); ?>">
            Profil Singkat
        </a>
    </li>

    <li>
        <a class="<?php echo e(request()->routeIs('about.history') ? 'active' : ''); ?>"
           href="<?php echo e(route('about.history')); ?>">
            Sejarah
        </a>
    </li>

    <li>
        <a class="<?php echo e(request()->routeIs('about.vision-mission') ? 'active' : ''); ?>"
           href="<?php echo e(route('about.vision-mission')); ?>">
            Visi & Misi
        </a>
    </li>

    <li>
        <a class="<?php echo e(request()->routeIs('facilities.*') ? 'active' : ''); ?>"
           ...
           <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('teachers*') ? 'active' : ''); ?>"
                href="<?php echo e(route('teachers')); ?>">
                    Guru & Staff
                </a>
            </li>

           <li class="nav-item dropdown">
  <a class="nav-link <?php echo e(request()->routeIs('information.*') || request()->routeIs('information*') ? 'active' : ''); ?>" href="#">
