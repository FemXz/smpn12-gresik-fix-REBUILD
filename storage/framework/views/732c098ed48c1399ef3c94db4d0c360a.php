    ...
    <div class="sidebar-body">
        ...
        <ul class="sidebar-nav">
             ...
             <li class="sidebar-item dropdown">
                ...
                <ul class="sidebar-submenu">
                   <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('information.news')); ?>">Berita</a></li>
                    <li><a href="<?php echo e(route('information.ppdb')); ?>">PPDB</a></li>
                </ul>
            </li>
            ...
            <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('gallery')); ?>">Galeri</a></li>
             <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('contact.index')); ?>">Kontak</a></li>
            </li>
        </ul>
    </div>
...
<?php /**PATH C:\Users\Lenovo\laragon\www\smpn12-gresik-website\resources\views/layouts/app.blade.php ENDPATH**/ ?>