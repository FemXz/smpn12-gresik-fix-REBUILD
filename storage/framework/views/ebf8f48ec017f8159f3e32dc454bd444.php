<?php $__env->startSection('title', 'Galeri - SMPN 12 Gresik'); ?>
    ...
    <div class="container">
        <div class="header-content">
            ...
            <div class="school-logo">
               <img src="<?php echo e(asset('assets/logo-smp.png')); ?>" alt="Logo Sekolah">
            </div>
            ...
            <div class="stats">
                <div class="stat-item">
                    <div class="stat-number" id="photoCount"><?php echo e($galleries->where('youtube_url', null)->count()); ?></div>
                    <div class="stat-label">
                        <i class="fas fa-camera"></i>Foto
                    </div>
                </div>
                <div class="stat-item">
                    <div class="stat-number" id="videoCount"><?php echo e($galleries->where('youtube_url', '!=', null)->count()); ?></div>
                    <div class="stat-label">
                        <i class="fas fa-video"></i>Video
                    </div>
                </div>
                <div class="stat-item">
                    <div class="stat-number" id="totalCount"><?php echo e($galleries->total()); ?></div>
                    <div class="stat-label">
    ...
    <div class="main-content">
        ...
        <div class="filter-section">
            ...
            <div class="filter-buttons">
                <button onclick="filterContent('all')" class="filter-btn active">
                    ...
                    <span class="filter-count" id="allCount"><?php echo e($galleries->total()); ?></span>
                </button>
                <button onclick="filterContent('photo')" class="filter-btn">
                    <i class="fas fa-camera"></i>
                    <span>Foto</span>
                    <span class="filter-count" id="photoFilterCount"><?php echo e($galleries->where('youtube_url', null)->count()); ?></span>
                </button>
                <button onclick="filterContent('video')" class="filter-btn video-btn">
                    <i class="fas fa-video"></i>
                    <span>Video</span>
                    <span class="filter-count" id="videoFilterCount"><?php echo e($galleries->where('youtube_url', '!=', null)->count()); ?></span>
                </button>
            </div>
        </div>
        ...
        <div id="galleryGrid" class="gallery-grid">
            <?php $__empty_1 = true; $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php if($item->image): ?>
                    <div class="gallery-item" data-type="photo" onclick='openModal(<?php echo json_encode($item, 15, 512) ?>)'>
                        <div class="gallery-image">
                            <img src="<?php echo e(asset($item->image)); ?>" alt="<?php echo e($item->title); ?>" onerror="this.parentElement.innerHTML='<div style=\'display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; color: #9ca3af;\'>📷<br><span style=\'font-size: 0.875rem; margin-top: 8px;\'>Foto tidak dapat dimuat</span></div>';">
                        ...
                        <div class="gallery-content">
                            <h3 class="gallery-title"><?php echo e($item->title); ?></h3>
                            <p class="gallery-description"><?php echo e($item->description ?? 'Tidak ada deskripsi tersedia.'); ?></p>
                            <div class="gallery-footer">
                                <span class="gallery-meta">
                                    <i class="fas fa-eye"></i>
                                    Klik untuk melihat
                                </span>
                                <span class="gallery-date"><?php echo e($item->created_at->format('d M Y')); ?></span>
                            </div>
                        </div>
                    </div>
...
<?php if($youtubeId): ?>
    <div class="gallery-item" data-type="video" onclick='openModal(<?php echo json_encode($item, 15, 512) ?>)'>
        <div class="gallery-image">
            <img src="https://img.youtube.com/vi/<?php echo e($youtubeId); ?>/maxresdefault.jpg"
                 alt="<?php echo e($item->title); ?>"
                 onerror="this.onerror=null;this.src='https://img.youtube.com/vi/<?php echo e($youtubeId); ?>/hqdefault.jpg';">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\laragon\www\smpn12-gresik-website\resources\views/gallery/index.blade.php ENDPATH**/ ?>