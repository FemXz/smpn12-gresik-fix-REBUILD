            ...
            <div class="teacher-detail-sidebar">
              <div class="teacher-detail-avatar">
                <?php if($teacher->photo): ?>
                  <img src="<?php echo e(asset('storage/'.$teacher->photo)); ?>" alt="<?php echo e($teacher->name); ?>" loading="lazy">
                <?php else: ?>
              ...
              <div class="additional-info">
                ...
                <div class="info-grid">
                  <div class="info-item">
                    ...
                    <p><?php echo e($teacher->education ?? 'Tidak tersedia'); ?></p>
                  </div>
                  <div class="info-item">
                    <i class="fas fa-briefcase"></i>
                    <strong>Pengalaman</strong>
                    <p><?php echo e($teacher->experience ?? 'Tidak tersedia'); ?></p>
                  </div>
                  <div class="info-item">
                    <i class="fas fa-book"></i>
                    <strong>Keahlian</strong>
                    <p><?php echo e($teacher->expertise ?? 'Tidak tersedia'); ?></p>
                  </div>
                </div>
              </div>
          ...
          <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="teacher-card">
              ...
              <div class="teacher-content">
                ...
                <p class="teacher-bio"><?php echo e($teacher->bio ?? 'Guru profesional yang berdedikasi dalam memberikan pendidikan berkualitas.'); ?></p>

                <div class="teacher-actions">
                 <a href="<?php echo e(route('teachers.show', $teacher)); ?>" class="btn btn-sm btn-outline">
                        Lihat Profil
                    </a>
                  <?php if($teacher->email): ?>
                    <a href="mailto:<?php echo e($teacher->email); ?>" class="btn btn-outline" title="Hubungi via Email">
                      <i class="fas fa-envelope"></i>
                    </a>
                  <?php endif; ?>
                </div>
