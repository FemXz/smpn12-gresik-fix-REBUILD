<?php $__env->startSection("title", isset($teacher) ? $teacher->name . " - Guru & Staff - SMP Negeri 12 Gresik" : "Guru & Staff - SMP Negeri 12 Gresik"); ?>
        ...
        <nav class="breadcrumb">
            <div class="container">
                <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route("teachers")); ?>">Guru & Staff</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo e($teacher->name); ?></li>
                </ul>
            </div>
        </nav>
                    ...
                    <div class="teacher-detail-content">
                        <div class="teacher-detail-grid">
                                ...
                                <div class="contact-info">
                                    ...
                                    <?php if($teacher->nip): ?>
                                        <div class="contact-item">
                                            ...
                                            <span>NIP: <?php echo e($teacher->nip); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="teacher-detail-main">
                                ...
                                <p class="teacher-detail-position"><?php echo e($teacher->position); ?></p>
                                ...
                                <?php if($teacher->bio): ?>
                                    ...
                                    <div class="bio-section">
                                        ...
                                        <div class="bio-content">
                                            <p><?php echo nl2br(e($teacher->bio)); ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
                        ...
                        <div class="navigation-section">
                            <div class="navigation-grid">
                                <div class="nav-left">
                                    <a href="<?php echo e(route("teachers")); ?>" class="btn btn-outline">
                                ...
                                <div class="related-card">
                                    <div class="related-avatar">
                                        <?php if($related->photo): ?>
                                            <img src="<?php echo e(asset("storage/" . $related->photo)); ?>" alt="<?php echo e($related->name); ?>">
                                        <?php else: ?>
                                    ...
                                    <h4 class="related-name"><?php echo e($related->name); ?></h4>
                                    <p class="related-position"><?php echo e($related->position); ?></p>
                                    <a href="<?php echo e(route("teachers.show", $related->slug)); ?>" class="btn btn-sm btn-outline">Lihat Profil</a>
                                </div>
                    ...
                    <?php if($teachers->count() > 0): ?>
                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="teacher-card">
                                ...
                                <h3 class="teacher-name"><?php echo e($teacher->name); ?></h3>
                                <p class="teacher-position"><?php echo e($teacher->position); ?></p>
                                <p class="teacher-bio"><?php echo e(Str::limit($teacher->bio, 80)); ?></p>
                                <a href="<?php echo e(route("teachers.show", $teacher->slug)); ?>" class="btn btn-primary">
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\laragon\www\smpn12-gresik-website\resources\views/teachers/index.blade.php ENDPATH**/ ?>