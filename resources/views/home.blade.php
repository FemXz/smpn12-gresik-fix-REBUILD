        ...
        <div class="welcome-hero__container">
            ...
            <div class="welcome-hero__image-wrapper">
                <div class="welcome-hero__image">
                    <img src="{{ $hero && $hero->image ? asset($hero->image) : 'https://via.placeholder.com/600x500?text=Foto+Kepala+Sekolah' }}" alt="Kepala Sekolah">
                    
                    <!-- Name Badge Overlay -->
                    <div class="welcome-hero__name-badge">
                        <div class="welcome-hero__name-badge-name">
                            {{ $hero->name ?? 'Drs. Nama Kepala Sekolah' }}
                        </div>
                        <div class="welcome-hero__name-badge-position">
                            {{ $hero->position ?? 'Kepala Sekolah' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="welcome-hero__content">
                <div class="welcome-hero__subtitle">
                    {{ $hero->subtitle ?? 'Sambutan Kepala Sekolah' }}
                </div>
                ...
                <p class="welcome-hero__text">
                    {{ $hero->text1 ?? 'Assalamu\'alaikum... (teks default jika belum ada data)' }}
                </p>

                <p class="welcome-hero__text">
                    {{ $hero->text2 ?? 'Setiap siswa adalah aset berharga... (teks default)' }}
                </p>
    ...
    <div class="tentang-container">
        ...
        <div class="tentang-content">
            <div class="tentang-image">
                     <img src="{{ asset('assets/ha.jpg') }}" alt="Foto Smpn">
        </div>
...
<section class="facilities-section">
    <div class="container">
        ...
        @if(!empty($data['facilities']) && count($data['facilities']) > 0)
        <div class="swiper facilitySwiper">
            <div class="swiper-wrapper">
                @foreach($data['facilities'] as $facility)
                <div class="swiper-slide">
                    <div class="facility-card">
                        <img src="{{ asset('storage/' . $facility->image) }}" class="facility-image" alt="{{ $facility->name }}">
        ...
        {{-- BUTTON RAPI DI BAWAH --}}
        <div class="btn-wrapper">
            <a href="{{ route('facilities.index') }}" class="btn-premium">
...
<section class="news-section relative py-24 bg-white overflow-hidden">
    ...
    <div class="container relative z-10 mx-auto px-4 max-w-7xl">
            ...
            <div class="swiper news-swiper !overflow-visible md:!overflow-hidden px-4">
                <div class="swiper-wrapper">
                    @if(isset($data['latest_news']) && $data['latest_news']->count())
                        @foreach($data['latest_news'] as $index => $item)
                            <div class="swiper-slide h-auto py-6">
                                <article class="premium-news-card group">
                                    <!-- Image Container -->
                                    <div class="card-image-box">
                                        @if($item->image)
                                            <img src="{{ asset($item->image) }}" alt="{{ $item->title }}" class="card-img" loading="lazy">
                                        @else
                                        ...
                                        <div class="card-overlay">
                                            <a href="{{ route('information.news.show', $item->slug) }}" class="overlay-icon">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h3 class="card-title">
                                            <a href="{{ route('information.news.show', $item->slug) }}">
                                                {{ $item->title }}
                                            </a>
                                        </h3>
                                        ...
                                        <div class="card-footer">
                                            <a href="{{ route('information.news.show', $item->slug) }}" class="read-more-btn">
        ...
        <div class="text-center mt-12" data-aos="fade-up">
            <a href="{{ route('information.news') }}" class="view-all-btn group">
                                ...
                                @foreach($achievements as $item)
                                    <div class="swiper-slide">
                                        <div class="ach-image-box">
                                            @if($item->image)
                                                <img src="{{ asset($item->image) }}" alt="{{ $item->title }}" class="ach-img">
                                            @else
                            ...
                            @foreach($achievements as $item)
                                <div class="swiper-slide">
                                    <div class="ach-info">
                                        ...
                                        <h2 class="ach-title">{{ $item->title }}</h2>
                                        <p class="ach-desc">
                                            {{ Str::limit(strip_tags($item->content), 180, '...') }}
                                        </p>
                                       <a href="{{ route('information.news', ['category' => 'Prestasi']) }}" class="ach-btn">
            ...
            <div class="ppdb-content-v3">
                <div class="ppdb-header-v3">
                    <span class="ppdb-badge-v3">
                        {{ optional($ppdb)->section_badge ?? 'SPMB T.A.' }}
                    </span>
            ...
            <div class="flex flex-col lg:flex-row gap-6 lg:gap-10 items-start">
                    ...
                    <div class="featured-teacher-card-premium overflow-hidden bg-white rounded-2xl shadow-lg shadow-green-900/5 border border-gray-100">
                        <div class="relative">
                            ...
                            <div class="featured-image-wrapper aspect-[4/5] overflow-hidden">
                                <img
                                    src="{{ $teachers->first()->photo ? asset('storage/'.$teachers->first()->photo) : 'https://ui-avatars.com/api/?name=' . urlencode($teachers->first()->name) . '&background=random' }}"
                ...
                <div class="w-full lg:w-[65%]" data-aos="fade-left">
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
                        @foreach($teachers as $teacher)
                            <div class="teacher-card-mini group cursor-pointer"
                                 ...
                                 data-foto="{{ $teacher->photo ? asset('storage/'.$teacher->photo) : 'https://ui-avatars.com/api/?name=' . urlencode($teacher->name) . '&background=random' }}">
                                ...
                                <div class="relative aspect-square rounded-xl overflow-hidden border-2 border-gray-200 group-[.active]:border-green-500 transition-all duration-300 shadow-sm hover:shadow-md group-[.active]:shadow-md group-[.active]:shadow-green-500/20">
                                    <img
                                        src="{{ $teacher->photo ? asset('storage/'.$teacher->photo) : 'https://ui-avatars.com/api/?name=' . urlencode($teacher->name) . '&background=random' }}"
                                        alt="{{ $teacher->name }}"
                                    ...
                                    <div class="absolute inset-0 bg-gradient-to-t from-green-900/70 to-transparent opacity-0 group-hover:opacity-100 group-[.active]:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-2">
                                        <h4 class="text-white font-bold text-[10px] leading-tight truncate">{{ $teacher->name }}</h4>
                                        <p class="text-green-300 text-[8px] truncate">{{ $teacher->position }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="mt-8 lg:mt-10 text-center lg:text-left">
                        <a href="{{ route('teachers') }}" class="inline-flex items-center justify-center lg:justify-start gap-2 w-full sm:w-auto px-5 py-3 bg-white border-2 border-green-600 text-green-600 font-bold text-sm rounded-xl hover:bg-green-600 hover:text-white transition-all duration-300 shadow-md group">
    ...
    <div class="container">
        <div class="cta-content" data-aos="fade-up">
            ...
            <div class="cta-buttons">
                ...
                <a href="{{ route('about.organization') }}" class="btn btn-outline">
